...
class CustomText(tk.Text):
    def __init__(self, *args, **kwargs):
        ...
        self.tag_configure("error_line", background="#FFE4E4")
        self.tag_configure("error_char", background="#FF9999")
        self._line_numbers = tk.Text(
            self.master, width=4, padx=4, pady=5, takefocus=0,
            border=0, background='#F0F0F0', foreground='#666666',
            font=("Consolas", 12)
        )
    ...
    def show_tooltip(self, event, message, position):
        ...
        label = tk.Label(
            self.tooltip, text=message, justify="left",
...
class LexerGUI:
    def __init__(self, root: tk.Tk):
        ...
        self.error_help_messages = {
            LexicalErrorCode.UNDEFINED_TOKEN.value: {
